...
const buttonSx = {
  ...
  async function handleSubmit() {
    ...
    let response = await api.addItem(
      itemName,
      quantity,
      selectedCategoryId,
      itemBarcode,
    ...
    if (data.success) {
      ...
      toast.error(
        'Barcode already exists in the database. Go to Shipment page to add to inventory.',
      );
    } else {
        ...
        <Paper elevation={3}>
          <div className="grid-item item2">
            <div className="addItem">
              <ToastWrapper />
              <h1 style={{fontSize: '2rem', fontWeight: 'bold'}}>Add New Item</h1>
